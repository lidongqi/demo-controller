...
import (
	...
	ldqtestcomv1 "github.com/lidongqi/demo-controller/apis/ldq.test.com/v1"
	versioned "github.com/lidongqi/demo-controller/generated/clientset/versioned"
	internalinterfaces "github.com/lidongqi/demo-controller/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/lidongqi/demo-controller/generated/listers/ldq.test.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.LdqV1().Nginxes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LdqV1().Nginxes(namespace).Watch(context.TODO(), options)
			},
		},
		&ldqtestcomv1.Nginx{},
		resyncPeriod,
...
func (f *nginxInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ldqtestcomv1.Nginx{}, f.defaultInformer)
}
